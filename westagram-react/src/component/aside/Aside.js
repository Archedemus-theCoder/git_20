        ...
        return (
            <div className="mainRightArea">
                        <div className="myProfile">
                            <img className="profileThumnailRight" alt="profileThRight" src="/images/profileThumnail.png"/>
                            ...
                            <div className="rightStoryAccounts">
                                <ol>
                                    <li className="rightStoryEachAccount">
                                        <img className="rightStoryProfileThumnail" alt="profile thumnail" src="/images/profileThumnail.png"/>
                                        <div>
                                            <p>archedemus</p>
                                            <p>2시간전</p>
                                        </div>
